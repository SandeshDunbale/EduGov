...
public class ResourceController {
    ...
    public ResponseEntity<ResourceResponse> create(@Valid @RequestBody ResourceCreateRequest req) {
        auditService.logAction("CREATE_RESOURCE", "PROGRAM_ID_" + req.programId());
    ...
    public ResourceResponse updateStatus(@PathVariable Long id,
        ...
        auditService.logAction("UPDATE_RESOURCE_STATUS", "RESOURCE_ID_" + id);
    ...
    public ResponseEntity<ResourceResponse> update(
        ...
        auditService.logAction("UPDATE_RESOURCE", "RESOURCE_ID_" + id);
    ...
    public ResourceResponse allocate(@PathVariable Long id,
        ...
        auditService.logAction("ALLOCATE_RESOURCE", "RESOURCE_ID_" + id);
    ...
    public ResponseEntity<DeleteResourceResponse> delete(@PathVariable Long id) {
        auditService.logAction("DELETE_RESOURCE", "RESOURCE_ID_" + id);
