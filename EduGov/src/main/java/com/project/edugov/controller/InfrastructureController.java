...
public class InfrastructureController {
    ...
    public ResponseEntity<InfrastructureResponse> create(
        ...
        auditService.logAction("CREATE_INFRASTRUCTURE", "PROGRAM_ID_" + req.programId());
    ...
    public InfrastructureResponse updateStatus(
        ...
        auditService.logAction("UPDATE_INFRASTRUCTURE_STATUS", "INFRA_ID_" + id);
    ...
    public ResponseEntity<InfrastructureResponse> update(
        ...
        auditService.logAction("UPDATE_INFRASTRUCTURE", "INFRA_ID_" + id);
    ...
    public ResponseEntity<Void> delete(@PathVariable Long id) {
        auditService.logAction("DELETE_INFRASTRUCTURE", "INFRA_ID_" + id);
